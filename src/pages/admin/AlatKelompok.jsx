    ...
    <div className="min-h-screen bg-gray-100 px-4 py-6 sm:px-6 md:px-10 lg:px-16 xl:px-24">
      ...
      >
        <h2 className="text-lg sm:text-xl font-semibold text-gray-700">
          {editingId ? 'Edit Produk' : 'Tambah Produk Kelompok'}
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              placeholder="Contoh: Sensor Kelembaban"
              required
              className="border border-gray-300 p-2 rounded w-full"
            />
            <p className="text-sm text-gray-500 mt-1">Masukkan nama alat atau paket produk.</p>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="border border-gray-300 p-2 rounded w-full"
            />
            <p className="text-sm text-gray-500 mt-1">Harga beli per unit alat (dalam Rupiah).</p>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="border border-gray-300 p-2 rounded w-full"
            />
            <p className="text-sm text-gray-500 mt-1">Harga sewa per hari (bila ada).</p>
          </div>
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            onChange={handleChange}
            placeholder="Tulis deskripsi produk seperti fungsi, keunggulan, dll."
            rows={4}
            className="border border-gray-300 p-2 rounded w-full"
          />
          <p className="text-sm text-gray-500 mt-1">Deskripsi singkat tentang produk atau alat.</p>
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="w-full"
          />
          <p className="text-sm text-gray-500 mt-1">Gambar produk untuk ditampilkan di daftar alat.</p>
        </div>
...
{/* Daftar Produk: Tabel untuk Desktop */}
      ...
      {/* Daftar Produk: Card untuk Mobile */}
